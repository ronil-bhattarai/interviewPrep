...
public class TreeTraversal {
    ...
    public static void main(String[] args) {
        ...
        // Traverse a binary tree level-by-level, but alternate the direction:
        // Left → Right on level 0. Right → Left on level 1. Left → Right on level 2 and so on…
        ...
        // Return true if there exists a root-to-leaf path such that the sum of the node values equals targetSum
        ...
        // This path may or may not pass through the root. The path is measured in number of edges, not nodes.
